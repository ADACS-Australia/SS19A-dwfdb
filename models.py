...
# set up a table for testing purposes only not for use in production
class Testdb(db.Model):
    ...
    ra = db.Column(db.Float, nullable=False)
    dec = db.Column(db.Float, nullable=False)
    dateplusone = db.Column(db.Integer)
    path = db.Column(db.String(), nullable=False)

    def __init__(self, author, created, body, maryid, dateplusone, path):
        self.author = author
        self.created = created
        self.ra = body
        self.dec = maryid
        self.dateplusone = dateplusone
        self.path = path
